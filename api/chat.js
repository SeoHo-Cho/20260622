...
[출력 형식 규칙 — 매우 중요]
- HTML 태그(<ul>, <li>, <b>, <br> 등)와 마크다운 기호(*, #, -, > 등)를 절대 사용하지 마세요.
- 오직 일반 텍스트로만 작성하세요. 강조나 목록이 필요하면 줄바꿈으로 구분하세요.
- 숫자를 작은따옴표나 따옴표로 감싸지 마세요. 예: '23'일 (X) → 23일 (O)
- 각 번호 설명은 "번호: 설명" 형태로 한 줄씩, 줄바꿈으로 구분하세요.`;
